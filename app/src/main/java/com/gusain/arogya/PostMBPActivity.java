...
public class PostMBPActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_mbp);
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("MBP");
    ...
    private void StartPosting()
    {
        ...
        if( !TextUtils.isEmpty(title_val) && !TextUtils.isEmpty(desc_val)  && mImageUri != null ){
            ...
            StorageReference filepath= mStorage.child("MBP_images").child(mImageUri.getLastPathSegment());
                            ...
                            newPost.child("username").setValue(dataSnapshot.child("name").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if(task.isSuccessful()){
                                        startActivity(new Intent(PostMBPActivity.this,MBPlansActivity.class));
